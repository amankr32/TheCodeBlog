...
// CORS configuration.
// In production, set CLIENT_URL to your deployed frontend's URL
// (e.g. https://your-app.vercel.app). Any *.vercel.app preview deployment
// is allowed too, which is handy for PR previews.
app.use(
  cors({
    origin:
